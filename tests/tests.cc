...
TEST(Functions_test, contain_time_test) {
    ...
    cout << "Contain 100000 - " << contain_time(100000, 200) << endl;
}
TEST(Functions_test, insert_time_test) {
    ...
    cout << "Insert 100000 - " << insert_time(100000, 200) << endl;
}
TEST(Functions_test, erase_time_test) {
    ...
    cout << "Erase 100000 - " << insert_time(100000, 200) << endl;
}
...
TEST(Functions_test, contain_time_test_vect) {
    ...
    cout << "Contain_vect 100000 - " << contain_time_vect(100000, 200) << endl;
}
TEST(Functions_test, insert_time_test_vect) {
    ...
    cout << "Insert_vect 100000 - " << insert_time_vect(100000, 200) << endl;
}
TEST(Functions_test, erase_time_test_vect) {
    ...
    cout << "Erase_vect 100000 - " << insert_time_vect(100000, 200) << endl;
}