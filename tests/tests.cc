...
TEST(Functions_test, insert_time_test) {
    cout << "Insert 1000 - " << insert_time(1000, 100) << endl;
    cout << "Insert 10000 - " << insert_time(10000, 100) << endl;
    cout << "Insert 100000 - " << insert_time(100000,10) << endl;
}
...
TEST(Functions_test, union_test) {
    Set<int> a;
    a.insert(10);
    a.insert(11);
    Set<int> b(a);
